...
local config = {
    ...
    stances = {
...

        {
            ...
            category = 'damage',
            evasionBonus = 8,   -- Soul-bond sharpens reactions; strong dodge
            perks = {
                {
...

        {
            ...
            category = 'ranged',
            evasionBonus = 6,   -- Ranged discipline; distance is its own dodge
            perks = {
                {
...

        {
            ...
            category = 'ranged',
            evasionBonus = 6,   -- Agility-governed; mobile and evasive
            perks = {
                {
...

        {
            ...
            integrations = { 'staves' },
            category = 'magic',
            evasionBonus = 4,   -- Mobile caster; deliberate footwork
            perks = {
                {
...

        {
            ...
            category = 'speed',
            evasionBonus = 8,   -- Speed-governed dual fighter; mobile and hard to pin
            perks = {
                {
...

        {
            ...
            integrations = {},
            category = 'damage',
            evasionBonus = 3,   -- Committed two-handed swings; limited footwork
            perks = {
                {
...

        {
            ...
            integrations = {},
            category = 'damage',
            evasionBonus = 5,   -- Reach keeps threats at distance; lateral footwork
            perks = {
                {
...

        {
            ...
            category = 'damage',
            evasionBonus = 2,   -- Heavy tool, underground work; poor dodge instinct
            perks = {
                {
...

        {
            ...
            category = 'utility',
            evasionBonus = 3,   -- Patient and still; calm awareness helps a little
            perks = {
                {
...

        {
            ...
            category = 'utility',
            evasionBonus = 5,   -- Range-oriented; keeps enemies at flask distance
            perks = {
                {
...

        {
            ...
            integrations = {},
            category = 'damage',
            evasionBonus = 3,   -- Heavy, strength-governed; evasion is not its strength
            perks = {
                {
...

        {
            ...
            integrations = {},
            category = 'damage',
            evasionBonus = 2,   -- Heaviest weapons; slow, committed stance
            perks = {
                {
...

        {
            ...
            integrations = {},
            category = 'damage',
            evasionBonus = 5,   -- Mobile single-weapon fighter; free hand aids balance
            perks = {
                {
...

        {
            ...
            integrations = {},
            category = 'speed',
            evasionBonus = 10,  -- Speed + short blade; the most evasive melee stance
            perks = {
                {
