...
I.Settings.registerGroup {
    ...
    settings = {
        ...
        { key = 'enableFortifier',   renderer = 'checkbox', name = 'SettingEnableFortifier',   description = 'SettingEnableFortifierDescription',   default = true },
...
I.Settings.registerGroup {
    ...
    settings = {
        ...
        { key = 'enableFortifierPerks',   renderer = 'checkbox', name = 'SettingEnableFortifierPerks',   description = 'SettingEnableFortifierPerksDescription',   default = true },
